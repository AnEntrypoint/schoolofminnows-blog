    ...
    <div data-role="Header" className={`header-header ${props.rootClassName} `}>
      <div className="header-container">
        <Link to="/" className="header-navlink">
          <h1 className="header-heading textSM">{props.heading}</h1>
        </Link>
      ...
      <div className="header-container3">
        <a href="https://twitter.com/point">
        ...
        <a href="https://github.com/anentrypoint">
      ...
      <div data-type="MobileMenu" className="header-mobile-menu">
        <div className="header-top">
          <Link to="/" className="header-navlink3">
            <h1 className="header-heading1 textSM">{props.heading}</h1>
          </Link>
